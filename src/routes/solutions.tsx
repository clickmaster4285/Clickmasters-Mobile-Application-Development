...
export const Route = createFileRoute("/solutions")({
  head: () => {
    const title = "Solutions — ClickMasters";
    const description =
      "Industry-focused mobile solutions: startups, e-commerce, healthcare, fintech, education and logistics. Built to scale and convert.";
    const url = "https://wolfpack-partners.lovable.app/solutions";
    return {
      meta: [
        { title },
