...
import corribVideo from "@/assets/corrib-oil.mp4.asset.json";
import cutVideo from "@/assets/3d2cut.mp4.asset.json";
import neoVideo from "@/assets/neobank.mp4.asset.json";
