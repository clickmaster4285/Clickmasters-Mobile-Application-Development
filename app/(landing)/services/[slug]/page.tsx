...
import { getContentBySlug, allSlugs } from "@/content/servicesDetail/index";
...
export default async function ServiceDetailPage({
  ...
  // Get other services for the "More guides" section
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="px-4 pt-36 pb-4">
        <div className="mx-auto max-w-[85vw]">
          ...
          {/* Article body with client-side animations */}
