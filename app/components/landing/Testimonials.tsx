...
const items = [
  ...
  },
  {
    ...
    quote: "They didn't just build the app — they became our technical co-founders. Invaluable.",
  },
  {
    name: "Jessica Wu",
        ...
        <div className="mt-14 grid md:grid-cols-3 gap-6">
          {items.map((t, i) => (
            ...
            >
              ...
              <blockquote className="mt-5 text-cream/90 leading-relaxed">"{t.quote}"</blockquote>
