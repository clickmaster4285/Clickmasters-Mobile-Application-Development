  ...
  return (
    ...
    >
      ...
      >
        ...
        <Drift
          delay={1}
          className="absolute top-24 right-16 size-40 opacity-50"
        >
          <PaperAirplane tone="electric" className="size-full" />
        </Drift>
        <Drift
          delay={2}
          className="absolute bottom-32 left-1/4 size-24 opacity-60"
        >
      ...
      <div className="max-w-4xl mx-auto text-center relative">
        ...
        >
          <p className="font-script text-5xl md:text-7xl text-ink -rotate-2">
            grow your app idea
          </p>
          <Squiggle
            className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-48 text-hot-pink"
            tone="pink"
          />
        </motion.div>
        ...
        >
          Tell us your idea. We'll come back within 24 hours with a clear plan,
        ...
        <div className="mt-16 grid sm:grid-cols-3 gap-5 max-w-3xl mx-auto">
          ...
          >
            ...
            <p className="mt-1 font-semibold text-sm break-all">
              sale@clickmasters…
            </p>
